...
if( window.innerWidth >800){
  ...
  <div className="sticky-container">
    <main onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="main " >
    {workFlowAPI.map((x) => (
            <div
              key={x.h3}
              id="container"
            ...
            >
              <img src={x.img} className="imageContainer  md:h-[600px] w-[400px] carousel__card__image  relative" />
              {showIcon && (
        <div className="icon">
