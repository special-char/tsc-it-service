...
const Blog = async () => {
  ...
  // console.log("Blog data:", data?.data?.blogs?.data);

  return (
    <div className="px-container relative items-center z-[1] flex flex-col gap-10 pb-20 flex-wrap min-h-screen">
      <div className="heading w-full flex flex-col gap-3 md:flex-row md:justify-between items-center">
        ...
        <a
          href="/blogs"
          className="text-lg cursor-pointer relative block pb-1 after:w-0 hover:after:w-[100%] after:absolute after:h-[1px] after:bottom-0 after:left-0 after:bg-dimGray after:ease-in-out after:duration-[0.7s]"
        >
          View all Post
        </a>
      </div>
